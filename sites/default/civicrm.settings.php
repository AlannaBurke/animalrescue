...
if (!defined('CIVICRM_UF_DSN')) {
  define( 'CIVICRM_UF_DSN'           , 'mysql://root:root@localhost/animalrescue?new_link=true' );
}
...
$civicrm_root = '/Applications/MAMP/htdocs/animalrescue/sites/all/modules/contrib/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/Applications/MAMP/htdocs/animalrescue/sites/default/files/civicrm/templates_c/' );
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://animalrescue.dev/' );
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '2ac5a7275bfe561bbfc191b1a8428560' );
}
...
// define( 'CIVICRM_MAIL_LOG', '/Applications/MAMP/htdocs/animalrescue/sites/default/files/civicrm/templates_c//mail.log' );
// }
